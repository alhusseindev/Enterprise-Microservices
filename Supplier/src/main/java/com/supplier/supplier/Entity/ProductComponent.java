package com.supplier.supplier.Entity;
...
public class ProductComponent {
    ...
    //actual constructor
    public ProductComponent(Long id, String name, String unit, Double quantity, Double componentCost, Double componentPrice, LocalDateTime createdAt, String status){
        this.id = id;
        this.name = name;
        this.unit = unit;
